...
class MySQL
{
   ...
   */
    ...
    public function connect()
    {
        ...
        // Select database
        } elseif (!@mysqli_select_db($this->dbConn, $this->dbName)) {
     ...
     * @access public
     */
    public function fetchField($query, $i)
    {
        /*
     ...
     *
     */
    public function insert($strSQL, $getLastID = true, &$error_sql = '')
    {
     ...
     *
     */
    public function update($strSQL, &$error_sql = '')
    {
     ...
     *
     */
    public function delete($strSQL, &$error_sql = '')
    {
